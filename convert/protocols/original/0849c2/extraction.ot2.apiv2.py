import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/0849c2/extraction.ot2.apiv2.py"
...
def run(ctx):
    ...
    [time_incubation_minutes, time_airdry_minutes] = [0, 0]  if TEST_MODE_BIND_INCUBATE else [5.0, 3.0]
    ...
    filename = f"protocols/detailed_action_json/0849c2.json"
    output_data = {
