import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/sci-illumina-rna-enrichment-normalization/normalization.ot2.apiv2.py"
...
#            protocol.comment("New Vol Height = "+str(round(RSBHeight,2)))
    ...
    filename = f"protocols/detailed_action_json/sci-illumina-rna-enrichment-normalization.json"
    output_data = {
