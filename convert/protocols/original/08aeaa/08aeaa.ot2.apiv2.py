import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/08aeaa/08aeaa.ot2.apiv2.py"
...
def run(ctx):
    ...
    class VolHeightTracker:
        ...
        def tracker(self, vol):
            ...
            if self.labware_wells[well] + vol >= self.well_vol:
                ...
                well = next(iter(self.labware_wells))
            dh = (self.well_vol - self.labware_wells[well]) / self.area  * self.comp_coeff
    ...
    filename = f"protocols/detailed_action_json/08aeaa.json"
    output_data = {
