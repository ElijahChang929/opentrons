import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/1e744e/1e744e.ot2.apiv2.py"
...
def run(ctx):
    ...
    *************************************************************************
    ...
    filename = f"protocols/detailed_action_json/1e744e.json"
    output_data = {
