import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/53fec2/omega_pcr_cleanup.ot2.apiv2.py"
...
def run(ctx):
    ...
    def wash(vol, source, mix_reps=15, park=True, start_park=False,
        ...
        ctx.delay(minutes=5, msg='Incubating on MagDeck for  ' + str(5) + ' minutes.')
    ...
    filename = f"protocols/detailed_action_json/53fec2.json"
    output_data = {
