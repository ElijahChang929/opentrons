import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/nextera-flex-library-prep-cherrypick-samples/nextera_flex_cherrypick.ot2.apiv2.py"
...
def run(ctx):
    ...
    filename = f"protocols/detailed_action_json/nextera-flex-library-prep-cherrypick-samples.json"
    output_data = {
