import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/illumina-nextera-XT-library-prep-part2/nexteraXT_dna_library_prep_part2.ot2.apiv2.py"
...
def run(protocol):
    ...
    filename = f"protocols/detailed_action_json/illumina-nextera-XT-library-prep-part2.json"
    output_data = {
