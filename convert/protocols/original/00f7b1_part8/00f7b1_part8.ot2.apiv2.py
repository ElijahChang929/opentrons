import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/00f7b1_part8/00f7b1_part8.ot2.apiv2.py"
...
def run(ctx: protocol_api.ProtocolContext):
    ...
    def bead_mixing(well, pip, mvol, reps=10):
        ...
        for _ in range(reps):
            pip.aspirate(vol, well.bottom(3), rate=2)
    ...
    te_buff = temp_plate.rows()[0][:math.ceil(num_columns/6)]*12
    ...
    filename = f"protocols/detailed_action_json/00f7b1_part8.json"
    output_data = {
