import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/rem-pcr-plate/rem-pcr-plate.ot2.apiv2.py"
...
def run(protocol: protocol_api.ProtocolContext):
    [_source, _no_plates, _start,
     _vol_dispense, _touch_tip] = get_values(  # noqa: F821
    ...
    p10_multi = protocol.load_instrument(
        "p10_multi", "left", tip_racks=[tiprack_20])
    ...
    filename = f"protocols/detailed_action_json/rem-pcr-plate.json"
    output_data = {
