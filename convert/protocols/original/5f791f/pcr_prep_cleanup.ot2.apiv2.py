import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/5f791f/pcr_prep_cleanup.ot2.apiv2.py"
...
def run(ctx):
    ...
    if 'cleanup' in steps:
        ...
        ctx.pause('Run PCR on plate on magnetic module (slot 1). When  complete, replace plate on magnetic module, and replace source sample plate \
    ...
    filename = f"protocols/detailed_action_json/5f791f.json"
    output_data = {
