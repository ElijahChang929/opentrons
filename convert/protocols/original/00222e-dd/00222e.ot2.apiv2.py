import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/00222e-dd/00222e.ot2.apiv2.py"

import math

metadata = {
    'protocolName': 'Drug Dosing',
...
def run(ctx):
    ...
    source_plate = ctx.load_labware('thermoscientificnunc_96_wellplate_2000ul',
                                    '4', 'DRUG + YOYO-MEDIA')
    ...
    vol_air_gap = 0
    cell_lines = [
        source_plate.rows()[0][i*2] for i in range(num_cell_lines)]
    ...
    filename = f"protocols/detailed_action_json/00222e-dd.json"
    output_data = {
