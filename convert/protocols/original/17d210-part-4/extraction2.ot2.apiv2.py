import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/17d210-part-4/extraction2.ot2.apiv2.py"
...
metadata = {
    'protocolName': 'Verogen ForenSeq DNA Signature Prep Kit Part 4/5:  Extraction 2',
...
def run(ctx):
    ...
    def remove_supernatant(vol, pip=m300, park=False, direct=True):
        ...
        for i, (m, spot) in enumerate(zip(mag_samples_m, parking_spots)):
            ...
            if direct and vol +  air_gap_vol <= pip.tip_racks[0].wells()[0].max_volume:
    ...
    def wash(vol, source, mix_reps=10, park=True, resuspend=True):
        ...
        ctx.delay(minutes=settling_time, msg=f'Incubating on magnet for  {settling_time} minutes.')
    ...
    filename = f"protocols/detailed_action_json/17d210-part-4.json"
    output_data = {
