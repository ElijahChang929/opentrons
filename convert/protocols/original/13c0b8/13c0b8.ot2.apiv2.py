import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/13c0b8/13c0b8.ot2.apiv2.py"
...
def run(protocol):
    ...
    # Step 8
    protocol.pause('Please remove plate from temp deck and spin down plate.  When spun down, replace plate on temperature module and click RESUME.')
    ...
    filename = f"protocols/detailed_action_json/13c0b8.json"
    output_data = {
