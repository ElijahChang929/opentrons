import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/131de0/cnv.ot2.apiv2.py"
...
def run(ctx):
    ...
    if num_reps == 'quadruplicate':
        ...
        if num_mm > 12 or num_samples*num_mm > 192 or num_samples > 96:
            raise Exception('Invalid combination of number of samples /mastermixes.')
