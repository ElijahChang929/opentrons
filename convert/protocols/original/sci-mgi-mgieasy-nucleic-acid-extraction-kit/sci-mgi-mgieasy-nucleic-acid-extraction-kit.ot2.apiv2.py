import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/sci-mgi-mgieasy-nucleic-acid-extraction-kit/sci-mgi-mgieasy-nucleic-acid-extraction-kit.ot2.apiv2.py"
...
def run(ctx):
    ...
    filename = f"protocols/detailed_action_json/sci-mgi-mgieasy-nucleic-acid-extraction-kit.json"
    output_data = {
