import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/979d28/extraction.ot2.apiv2.py"
...
def run(ctx):
    ...
    def bind(vol, parking_spots, samples=mag_samples_m):
        ...
        ctx.pause('Place deepwell plate on magnetic module when  shaking is complete.')
    ...
    filename = f"protocols/detailed_action_json/979d28.json"
    output_data = {
