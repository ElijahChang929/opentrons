import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/macherey-nagel-nucleomag-dna-food/macherey-nagel-nucleomag-dna-food.ot2.apiv2.py"
...
metadata = {'protocolName': 'NucleoMag_DNA_Food_Rev01', 'author': 'Macherey-Nagel <automation-bio@mn-net.com>', 'apiLevel': '2.9'}
...
def run(ctx):
    ...
    [num_samples,
     ...
     sep_time_elu,
     dry_time,
     tip_track] = [48, 400, 100, 600, 25, 600, 600, 600, 0, 25, 20, 25, 5, 2, 5, 30, False]
    ...
    def wash(vol, source, mix_reps=mix_reps_wash, reuse=True, restore=True, resuspend=True, last=False, blowout=True):
        ...
        if reuse: #Dispense with fresh tips & mix with restored tips from previous step
            ...
            for i, (m) in enumerate(mag_samples_m):
                # src = source[i//(10//len(source))] neue Kalkulation mit 16mL Fassungvolumen der Resevoirkammern
    ...
    filename = f"protocols/detailed_action_json/macherey-nagel-nucleomag-dna-food.json"
    output_data = {
