import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/29225e-part-2/29225e-part-2.ot2.apiv2.py"
...
def run(ctx):
    ...
    rna_tfers = [tfer for tfer in tfers if (tfer['dest well'] in [
     ...
     'A'+str(num+1) for num in range(12)])] if pip20.name ==  "p20_multi_gen2" else tfers
    ...
    filename = f"protocols/detailed_action_json/29225e-part-2.json"
    output_data = {
