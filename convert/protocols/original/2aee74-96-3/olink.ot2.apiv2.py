import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/2aee74-96-3/olink.ot2.apiv2.py"
...
def run(ctx):
 ...
 Briefly,inject one control line fluid syringe into each accumulator on the  chip, and then prime the chip on the IFC Controller for approximately 20 \
    ...
    filename = f"protocols/detailed_action_json/2aee74-96-3.json"
    output_data = {
