import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/3e3c9d-protocol-Adding-BTM/3e3c9d-protocol-Adding-BTM.ot2.apiv2.py"
...
def run(protocol):
    ...
    filename = f"protocols/detailed_action_json/3e3c9d-protocol-Adding-BTM.json"
    output_data = {
