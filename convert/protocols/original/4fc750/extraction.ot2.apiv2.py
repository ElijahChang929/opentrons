import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/4fc750/extraction.ot2.apiv2.py"
...
def run(ctx):
    ...
    def wash(vol, source, mix_reps=15, park=True, resuspend=True,
        ...
        if air_dry:
            ctx.delay(minutes=air_dry_time, msg=f'Air drying {air_dry_time}  minutes.')
    ...
    filename = f"protocols/detailed_action_json/4fc750.json"
    output_data = {
