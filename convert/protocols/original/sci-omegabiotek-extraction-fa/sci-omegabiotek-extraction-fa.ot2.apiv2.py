import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/sci-omegabiotek-extraction-fa/sci-omegabiotek-extraction-fa.ot2.apiv2.py"
...
#    tempdeck.set_temperature(4)
    ...
    def bind(vol, park=True):
        ...
        for i, (well, spot) in enumerate(zip(mag_samples_m, parking_spots)):
            ...
            m300.air_gap(20)
            # removed if statement; tips will be parked for mixing
            m300.drop_tip(spot)
            # else:
            #     _drop(m300)
    ...
    filename = f"protocols/detailed_action_json/sci-omegabiotek-extraction-fa.json"
    output_data = {
