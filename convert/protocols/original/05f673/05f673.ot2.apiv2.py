import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/05f673/05f673.ot2.apiv2.py"
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    if prefill:
        if labwareType == 'corning_96_wellplate_360ul_flat':
            ...
            raise Exception('The prefill volume cannot be selected  with 24-well plate option.')
