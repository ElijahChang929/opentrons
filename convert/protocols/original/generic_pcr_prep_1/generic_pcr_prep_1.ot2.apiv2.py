import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/generic_pcr_prep_1/generic_pcr_prep_1.ot2.apiv2.py"
...
def run(ctx: protocol_api.ProtocolContext):
    ...
    # load labware
    labware_list = []
    for labware_lname, tmod, slot, name in  zip([labware_1_lname, labware_2_lname],
            [tmod1, tmod2],
            [labware_1_slot, labware_2_slot],
    ...
    filename = f"protocols/detailed_action_json/generic_pcr_prep_1.json"
    output_data = {
