import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/macherey-nagel-nucleomag-virus/macherey-nagel-nucleomag-virus.ot2.apiv2.py"
...
metadata = {'protocolName': 'NucleoMag_Virus_Rev01', 'author': 'Macherey-Nagel <automation-bio@mn-net.com>', 'apiLevel': '2.9'}
...
def run(ctx):
    ...
    [num_samples,
     ...
     sep_time_elu,
     dry_time,
     tip_track] = [48, 414, 100, 600, 30, 500, 500, 0,
                   20, 15, 20, 5, 2, 5, 20, False]
    ...
    if not 380 <= starting_vol <= 420:
        raise Exception('Starting volume should be from 360 - 420µl.')
    ...
    filename = f"protocols/detailed_action_json/macherey-nagel-nucleomag-virus.json"
    output_data = {
