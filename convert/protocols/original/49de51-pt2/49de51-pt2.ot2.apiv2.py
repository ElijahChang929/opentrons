import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/49de51-pt2/49de51-pt2.ot2.apiv2.py"
...
def run(protocol):
    ...
    filename = f"protocols/detailed_action_json/49de51-pt2.json"
    output_data = {
