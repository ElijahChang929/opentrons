import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/272c63/tube_filling.ot2.apiv2.py"
...
def run(ctx):
    ...
    def pick_up(pip):
        if tip_log[p1000]['tip_count'] >= tip_log[p1000]['tip_max']:
            ctx.pause('Please replace 1000ul tipracks in slots 1, 6, and 9  before resuming.')
    ...
    filename = f"protocols/detailed_action_json/272c63.json"
    output_data = {
