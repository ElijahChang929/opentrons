import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/29f643/29f643.ot2.apiv2.py"
...
def run(ctx: protocol_api.ProtocolContext):
    ...
    ctx.pause(
        '\nAddition of Detection Antibody complete. Please cover plate  and place on shaker for 1 hour at room temperature. When ready \
    ...
    ctx.pause('\nPlease place plate on shaker for 15 minutes.  When ready, replace plate and click RESUME')
    ...
    filename = f"protocols/detailed_action_json/29f643.json"
    output_data = {
