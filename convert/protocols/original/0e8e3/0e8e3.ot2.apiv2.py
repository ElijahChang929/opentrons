import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/0e8e3/0e8e3.ot2.apiv2.py"
...
def run(ctx):
    ...
    ctx.pause('Apply foil to top of DNAse Reaction Plate befroe tempdeck ramps  to 37C')
    ...
    filename = f"protocols/detailed_action_json/0e8e3.json"
    output_data = {
