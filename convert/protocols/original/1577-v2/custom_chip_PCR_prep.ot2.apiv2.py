import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/1577-v2/custom_chip_PCR_prep.ot2.apiv2.py"
...
def run(ctx):
    ...
    ctx.comment('Thermocycler holding block temperature at 12˚C. Manually  deactivate in the Opentrons App when ready.')
    ...
    filename = f"protocols/detailed_action_json/1577-v2.json"
    output_data = {
