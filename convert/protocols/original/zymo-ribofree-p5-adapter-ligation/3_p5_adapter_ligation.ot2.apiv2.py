import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/zymo-ribofree-p5-adapter-ligation/3_p5_adapter_ligation.ot2.apiv2.py"
...
def run(ctx):
    ...
    filename = f"protocols/detailed_action_json/zymo-ribofree-p5-adapter-ligation.json"
    output_data = {
