import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/3e3c9d-protocol-Adding-Water-RBC/3e3c9d-protocol-Adding-Water-RBC.ot2.apiv2.py"
...
def run(protocol):
    ...
    filename = f"protocols/detailed_action_json/3e3c9d-protocol-Adding-Water-RBC.json"
    output_data = {
