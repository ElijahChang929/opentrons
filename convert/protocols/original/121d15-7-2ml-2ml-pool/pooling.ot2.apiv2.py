import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/121d15-7-2ml-2ml-pool/pooling.ot2.apiv2.py"
...
def run(ctx):
    ...
    tuberack2_1_bar, tuberack15_1_bar =  input_file.splitlines()[3].split(',')[:2]
    ...
    if input_file2:
        tuberack2_2_bar, tuberack15_2_bar =  input_file2.splitlines()[3].split(',')[:2]
        if not tuberack15_1_scan[:len(tuberack15_1_scan)-4] ==  tuberack15_1_bar.strip():
