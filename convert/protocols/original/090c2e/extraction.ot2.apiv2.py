import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/090c2e/extraction.ot2.apiv2.py"
...
def run(ctx: protocol_api.ProtocolContext):
    ...
    filename = f"protocols/detailed_action_json/090c2e.json"
    output_data = {
