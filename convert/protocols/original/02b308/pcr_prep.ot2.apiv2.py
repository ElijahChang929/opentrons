import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/02b308/pcr_prep.ot2.apiv2.py"
...
def run(ctx):
    ...
    for i, primer in enumerate(primers):
        ...
        for plate in qpcr_plates:
            row = plate.rows()[i % 2]
            shift = (i // 2) * 3
            dests = row[shift:shift+3] +  row[shift+12:shift+12+3]
            for d in dests:
