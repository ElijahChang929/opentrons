import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/sci-macherey-nagel-nucleomag/sci-macherey-nagel-nucleomag.ot2.apiv2.py"
...
def run(ctx):
    ...
    [num_samples, deepwell_type, mag_height, z_offset, radial_offset, res_type,
     ...
     flash, p300_mount] = get_values(  # noqa: F821
        ...
        'settling_time', 'park_tips', 'tip_track', 'flash', 'p300_mount')
    ...
    filename = f"protocols/detailed_action_json/sci-macherey-nagel-nucleomag.json"
    output_data = {
