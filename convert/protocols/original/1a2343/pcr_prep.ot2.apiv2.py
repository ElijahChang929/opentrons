import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/1a2343/pcr_prep.ot2.apiv2.py"
...
def run(ctx):
    ...
    ctx.comment('Thermocycler block remaining at 72˚C incubation. Deactivate  through Opentrons App when ready.')
    ...
    filename = f"protocols/detailed_action_json/1a2343.json"
    output_data = {
