import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/121d15-2-96-Greiner-1000/redoreplacementpicking.ot2.apiv2.py"
...
# metadata
metadata = {
    'protocolName': 'Redo Replacement Picking (Greiner MASTERBLOCK 96 Well  Plate 1000 µL)',
...
def run(ctx):
    ...
    filename = f"protocols/detailed_action_json/121d15-2-96-Greiner-1000.json"
    output_data = {
