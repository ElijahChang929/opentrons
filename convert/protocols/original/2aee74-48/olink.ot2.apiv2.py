import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/2aee74-48/olink.ot2.apiv2.py"
...
def run(ctx):
    ...
    ctx.home()
    ctx.pause(f'P20 multi transfer will begin at column {tip_count+1} of  tiprack on slot 6.')
    ...
    ctx.comment('\n\n\n\n\nSeal the plate with an adhesive plastic film, spin  at 400 x g, 1 min at room temperature. Incubate overnight at +4°C.\n\n\n\n\n')
    ...
    filename = f"protocols/detailed_action_json/2aee74-48.json"
    output_data = {
