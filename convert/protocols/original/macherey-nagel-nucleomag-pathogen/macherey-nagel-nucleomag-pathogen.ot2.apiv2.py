import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/macherey-nagel-nucleomag-pathogen/macherey-nagel-nucleomag-pathogen.ot2.apiv2.py"
...
def run(ctx):
    ...
    filename = f"protocols/detailed_action_json/macherey-nagel-nucleomag-pathogen.json"
    output_data = {
