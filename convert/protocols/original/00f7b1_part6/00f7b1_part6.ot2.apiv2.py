import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/00f7b1_part6/00f7b1_part6.ot2.apiv2.py"
...
def run(ctx: protocol_api.ProtocolContext):
    ...
    # protocol
    ctx.comment('\n~~~~~~~~~~~ADDING REACTION BUFFER & ENZYME MIX~~~~~~~~~~\n')
    for dest in samples:
        pick_up(m20)
        m20.aspirate(10, rxn_buffer, rate=0.25)
        m20.dispense(10, dest, 0.25)
        drop_tip(m20)
    ...
    filename = f"protocols/detailed_action_json/00f7b1_part6.json"
    output_data = {
