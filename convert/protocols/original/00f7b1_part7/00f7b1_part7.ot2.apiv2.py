import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/00f7b1_part7/00f7b1_part7.ot2.apiv2.py"
...
metadata = {
    'protocolName': 'NEBNext Ultra II Directional RNA Library Prep Kit for  Illumina Part 7: Adaptor Ligation',
...
def run(ctx: protocol_api.ProtocolContext):
    ...
    filename = f"protocols/detailed_action_json/00f7b1_part7.json"
    output_data = {
