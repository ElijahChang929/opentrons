import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/magnesil/magnesil.ot2.apiv2.py"
...
def run(protocol):
    ...
    tip_type = 'opentrons_96_filtertiprack_200ul' if filter_tip  else 'opentrons_96_tiprack_300ul'
    ...
    filename = f"protocols/detailed_action_json/magnesil.json"
    output_data = {
