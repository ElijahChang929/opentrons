import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/nextera-flex-library-prep-amplify-tagmented-dna/nextera_flex_amplify_tagmented_dna.ot2.apiv2.py"
...
def run(ctx):
    ...
    ctx.comment('Add the appropriate index adapters to each sample and mix.  Seal the plate, centrifuge, and run the BLT PCR program.')
    ...
    filename = f"protocols/detailed_action_json/nextera-flex-library-prep-amplify-tagmented-dna.json"
    output_data = {
