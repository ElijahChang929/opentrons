import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/2b9486/ngs_prep.ot2.apiv2.py"
...
primer plate before resuming.')
    ...
    filename = f"protocols/detailed_action_json/2b9486.json"
    output_data = {
