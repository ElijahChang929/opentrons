import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/18e62e/18e62e.ot2.apiv2.py"
...
def run(protocol):
    ...
    def mm_creation(reagent, vol, rename):
        ...
        pip.pick_up_tip()
        protocol.comment(f'\nTransferring {vol}uL of {rename} to  {sampCols*8} wells in 384-Well Plate...')
    ...
    filename = f"protocols/detailed_action_json/18e62e.json"
    output_data = {
