import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/118e8c/118e8c.ot2.apiv2.py"
...
def run(ctx):
    ...
    default_current = ctx._implementation._hw_manager.hardware. _attached_instruments[p20m._implementation.get_mount()].\
    ...
    filename = f"protocols/detailed_action_json/118e8c.json"
    output_data = {
