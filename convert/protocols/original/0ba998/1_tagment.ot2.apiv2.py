import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/0ba998/1_tagment.ot2.apiv2.py"
...
def run(ctx):
    ...
    ctx.comment('Seal the plate with Microseal B, place on the  preprogrammed thermal cycler, and run the TAG program.')
    ...
    filename = f"protocols/detailed_action_json/0ba998.json"
    output_data = {
