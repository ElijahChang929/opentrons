import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/701319/701319.ot2.apiv2.py"
...
def run(ctx):
    ...
    [samples, m20_mount, m300_mount, mag_engage_height, bead_vol, asp_speed,
        ...
        "samples", "m20_mount", "m300_mount", "mag_engage_height", "bead_vol",
    ...
    filename = f"protocols/detailed_action_json/701319.json"
    output_data = {
