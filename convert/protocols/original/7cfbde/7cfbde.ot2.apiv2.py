import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/7cfbde/7cfbde.ot2.apiv2.py"
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    def pick_up():
        ...
        try:
            ...
            protocol.pause("\nReplace the tips in slots 9, 6, and 3.  Move empty rack to slot 8")
            m300.reset_tipracks()
            m300.pick_up_tip()
            tip_ctr = 0
    ...
    protocol.comment('Please replace 96-Well Plate containing Samples  with clean plate for elutions')
    ...
    filename = f"protocols/detailed_action_json/7cfbde.json"
    output_data = {
