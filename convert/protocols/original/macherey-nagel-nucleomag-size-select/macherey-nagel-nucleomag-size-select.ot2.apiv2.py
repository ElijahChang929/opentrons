import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/macherey-nagel-nucleomag-size-select/macherey-nagel-nucleomag-size-select.ot2.apiv2.py"
