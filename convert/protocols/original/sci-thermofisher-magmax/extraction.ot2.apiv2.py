import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/sci-thermofisher-magmax/extraction.ot2.apiv2.py"
...
def run(ctx):
    ...
    [num_samples, starting_vol, binding_buffer_vol, wash1_vol, wash2_vol,
     ...
     park_tips, tip_track] = get_values(  # noqa: F821
    ...
    def remove_supernatant(vol, park=False):
        ...
        def _waste_track(vol):
            ...
            if waste_vol + vol >= waste_threshold:
                m300.home()
                ctx.pause('Please empty liquid waste (slot 9) before  resuming.')
    ...
    def bind(vol, park=True):
        ...
        for i, (well, spot) in enumerate(zip(mag_samples_m, parking_spots)):
            ...
            if park:
                ...
                _drop(m300)
        ctx.delay(minutes=5, msg=f'Pause for {settling_time} minutes to shake  at 1,050rpm')
    ...
    filename = f"protocols/detailed_action_json/sci-thermofisher-magmax.json"
    output_data = {
