import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/macherey-nagel-nucleomag-clean-up/macherey-nagel-nucleomag-cleanup.ot2.apiv2.py"
...
def run(ctx):
    ...
    filename = f"protocols/detailed_action_json/macherey-nagel-nucleomag-clean-up.json"
    output_data = {
