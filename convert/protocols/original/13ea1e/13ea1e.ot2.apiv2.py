import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/13ea1e/13ea1e.ot2.apiv2.py"
...
def run(ctx):
    ...
    tuberack = ctx.load_labware('opentrons_24_tuberack_1500ul', '11')
    ...
    filename = f"protocols/detailed_action_json/13ea1e.json"
    output_data = {
