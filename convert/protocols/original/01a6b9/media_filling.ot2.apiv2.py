import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/01a6b9/media_filling.ot2.apiv2.py"
...
def run(ctx):
    ...
    tiprack_type = f'opentrons_96_filtertiprack_ {tip_vol_map[int(pipette.max_volume)]}ul'
