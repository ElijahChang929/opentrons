import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/sci-amplex-red/sci-amplex-red.ot2.apiv2.py"
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    filename = f"protocols/detailed_action_json/sci-amplex-red.json"
    output_data = {
