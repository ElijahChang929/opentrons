import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/9038af/normalization.ot2.apiv2.py"
...
def run(ctx):
    ...
    ctx.pause('Seal plate (slot 4). Incubate at 30°C for 2 minutes, then at  80°C for 2 minutes. Briefly put the plate on ice to cool.')
    ...
    filename = f"protocols/detailed_action_json/9038af.json"
    output_data = {
