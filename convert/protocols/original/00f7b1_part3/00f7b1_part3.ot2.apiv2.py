import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/00f7b1_part3/00f7b1_part3.ot2.apiv2.py"
...
metadata = {
    'protocolName': 'NEBNext Ultra II Directional RNA Library Prep Kit for Illumina Part 3: First cDNA Strand Synthesis',  # noqa
...
def run(ctx: protocol_api.ProtocolContext):
    ...
    strand_reagent = temp_plate.rows()[0][0]
    enzyme_mix = temp_plate.rows()[0][2]

    # protocol
    ctx.comment('\n~~~~~~~~~~~ADDING STRAND SPECIFICITY REAGENT~~~~~~~~~~~\n')
    for dest in samples:
        pick_up(m20)
        m20.aspirate(8, strand_reagent)
        m20.dispense(8, dest)
        drop_tip(m20)
    ...
    filename = f"protocols/detailed_action_json/00f7b1_part3.json"
    output_data = {
