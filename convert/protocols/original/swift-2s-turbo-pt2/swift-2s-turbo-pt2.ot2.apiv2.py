import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/swift-2s-turbo-pt2/swift-2s-turbo-pt2.ot2.apiv2.py"
...
def run(protocol):
    ...
    filename = f"protocols/detailed_action_json/swift-2s-turbo-pt2.json"
    output_data = {
