import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/0523c2/extraction.ot2.apiv2.py"
...
def run(ctx):
    ...
    for reagent_ind, reagent in enumerate(mm_map.values()):
        ...
        for i in range(num_transfers):
            ...
            if i == num_transfers - 1 and mix_after:
                ...
                if vol_mix_fraction*(
                        vol_mm_running) <= m300.max_volume -  min_mix_volume:
    ...
    for i, output in enumerate(outputs_s):
        ...
        if i > 0 and barcode_ind == 0:
            ctx.pause('Refills barcodes 1-16 in tube block, order A3, A4,  A5, A6, B3, B4 ... D5, D6. Resume when finished')
    ...
    filename = f"protocols/detailed_action_json/0523c2.json"
    output_data = {
