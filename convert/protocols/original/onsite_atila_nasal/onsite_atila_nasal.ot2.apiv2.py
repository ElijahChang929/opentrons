import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/onsite_atila_nasal/onsite_atila_nasal.ot2.apiv2.py"
...
def run(ctx: protocol_api.ProtocolContext):
    ...
    filename = f"protocols/detailed_action_json/onsite_atila_nasal.json"
    output_data = {
