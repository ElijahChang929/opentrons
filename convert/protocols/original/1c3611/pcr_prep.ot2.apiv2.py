import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/1c3611/pcr_prep.ot2.apiv2.py"
...
def run(ctx):
    ...
    plate_384_def = 'biorad_384_wellplate_50ul' if ctx.is_simulating()  else 'biorad_384_wellplate_50ul'
    ...
    filename = f"protocols/detailed_action_json/1c3611.json"
    output_data = {
