import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/17d210-part-3/extraction1.ot2.apiv2.py"
...
metadata = {
    'protocolName': 'Verogen ForenSeq DNA Signature Prep Kit Part 3/5:  Library Purification',
...
def run(ctx):
    ...
    filename = f"protocols/detailed_action_json/17d210-part-3.json"
    output_data = {
