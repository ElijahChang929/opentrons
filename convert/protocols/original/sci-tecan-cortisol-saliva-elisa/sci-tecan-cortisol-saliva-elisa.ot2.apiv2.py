import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/sci-tecan-cortisol-saliva-elisa/sci-tecan-cortisol-saliva-elisa.ot2.apiv2.py"
...
def run(ctx):
    ...
    filename = f"protocols/detailed_action_json/sci-tecan-cortisol-saliva-elisa.json"
    output_data = {
