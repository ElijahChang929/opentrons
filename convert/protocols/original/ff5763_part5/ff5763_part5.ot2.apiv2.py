import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/ff5763_part5/ff5763_part5.ot2.apiv2.py"
...
# transfer 30 ul supernatant from MIDI plate 2 to new 96 well pcr plate
    ...
    filename = f"protocols/detailed_action_json/ff5763_part5.json"
    output_data = {
