import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/79e9a1-cleanup/cleanup.ot2.apiv2.py"
...
def run(ctx):
    ...
    def remove_supernatant(vol,
        ...
        if not pip:
            pip = m300
        vol_airgap = pip.tip_racks[0].wells()[0].max_volume - vol  if pip.tip_racks[0].wells()[0].max_volume - vol < 20.0 \
            else 20.0
    ...
    filename = f"protocols/detailed_action_json/79e9a1-cleanup.json"
    output_data = {
