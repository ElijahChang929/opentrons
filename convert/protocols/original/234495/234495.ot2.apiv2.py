import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/234495/234495.ot2.apiv2.py"
...
def run(ctx):
    ...
    **locations relative to top and center coded accordingly**
    ...
    filename = f"protocols/detailed_action_json/234495.json"
    output_data = {
