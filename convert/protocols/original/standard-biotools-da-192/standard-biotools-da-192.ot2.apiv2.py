import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/standard-biotools-da-192/standard-biotools-da-192.ot2.apiv2.py"
...
def sbi_transfer(
    ...
    if not (aspirate and dispense):
        ...
        if not (mix_1 or mix_2):
            raise TypeError(
                "Must have a liquid handling step  (either: mix or aspirate+dispsense"
            )
        is_distribute = False
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    filename = f"protocols/detailed_action_json/standard-biotools-da-192.json"
    output_data = {
