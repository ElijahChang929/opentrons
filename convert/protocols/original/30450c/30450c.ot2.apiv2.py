import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/30450c/30450c.ot2.apiv2.py"
...
def run(ctx):
    ...
    bufferwells = 5*[
     ...
     ] if labware_reservoir != 'nest_12_reservoir_15ml'  else reagentreservoir.wells()[:5]
    ...
    filename = f"protocols/detailed_action_json/30450c.json"
    output_data = {
