import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/sci-idt-xgen-mc/sci-idt-xgen-mc.ot2.apiv2.py"
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    filename = f"protocols/detailed_action_json/sci-idt-xgen-mc.json"
    output_data = {
