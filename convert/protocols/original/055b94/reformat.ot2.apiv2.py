import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/055b94/reformat.ot2.apiv2.py"
...
#         out_csv_path_qs = f'protocols/055b94/supplements/ # {scan_9000_plate_barcode}_{scan_qpcr_plate_barcode}_QS5_Fire.txt'
    ...
    filename = f"protocols/detailed_action_json/055b94.json"
    output_data = {
