import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/111210-part-8/111210-part-8.ot2.apiv2.py"

from opentrons import protocol_api, types

metadata = {
    'protocolName': '''GeneRead QIAact Lung RNA Fusion UMI Panel Kit:
                       Cleanup of Target Enrichment PCR with QIAseq Beads''',
...
def run(ctx):
    ...
    # Combine Forward and Reverse PCRs
    for fwd, rev, dest in zip(tc_plate_wells_forward, tc_plate_wells_reverse,
                              mag_plate_wells):
        pick_up(p300)
    ...
    # Add 16 uL of Nuclease-Free Water to Elute DNA
    for well in mag_plate_wells:
        pick_up(p20)
        p20.aspirate(16, nfw)
    ...
    filename = f"protocols/detailed_action_json/111210-part-8.json"
    output_data = {
