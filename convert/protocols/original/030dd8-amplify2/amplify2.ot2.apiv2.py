import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/030dd8-amplify2/amplify2.ot2.apiv2.py"
...
thermal cycler and run the COVIDSeq TAG PCR program')
    ...
    filename = f"protocols/detailed_action_json/030dd8-amplify2.json"
    output_data = {
