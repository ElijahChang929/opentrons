import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/030dd8-amplify/amplify.ot2.apiv2.py"
...
def run(ctx):
    ...
    ctx.comment('\n\n\n\nProtocol complete.\nSeal and shake at 1600 rpm for 1  minute. Centrifuge at 1000 x g for 1 minute. Place in the preprogrammed \
    ...
    filename = f"protocols/detailed_action_json/030dd8-amplify.json"
    output_data = {
