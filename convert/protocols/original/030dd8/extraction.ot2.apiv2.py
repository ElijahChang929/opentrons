import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/030dd8/extraction.ot2.apiv2.py"
...
def run(ctx):
    ...
    ctx.delay(minutes=time_airdry_minutes, msg=f'Airdrying for  {time_airdry_minutes} minutes.')
    ...
    filename = f"protocols/detailed_action_json/030dd8.json"
    output_data = {
