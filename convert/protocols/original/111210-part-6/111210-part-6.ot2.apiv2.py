import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/111210-part-6/111210-part-6.ot2.apiv2.py"

from opentrons import protocol_api, types

metadata = {
    'protocolName': '''GeneRead QIAact Lung RNA Fusion UMI Panel Kit:
                    Cleanup of Adapter-ligated DNA with QIAseq Beads''',
...
def run(ctx):
    ...
    # Transfer 100 uL of Ligation Product to Mag Plate
    ...
    # Add 90 uL of Beads to DNA Mixture
    for dest in mag_plate_wells:
        pick_up(p300)
        p300.aspirate(90, beads)
        p300.dispense(90, dest)
        p300.mix(10, 100)
        p300.drop_tip()
    ...
    # Engaging Magnet for 10 minutes
    mag_mod.engage(height=engage_height)
    ctx.delay(minutes=10, msg='Engaging Magnetic Module for 10 minutes.')
    ...
    filename = f"protocols/detailed_action_json/111210-part-6.json"
    output_data = {
