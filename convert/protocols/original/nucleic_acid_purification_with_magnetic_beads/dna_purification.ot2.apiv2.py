import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/nucleic_acid_purification_with_magnetic_beads/dna_purification.ot2.apiv2.py"
...
def run(protocol_context):
    ...
    filename = f"protocols/detailed_action_json/nucleic_acid_purification_with_magnetic_beads.json"
    output_data = {
