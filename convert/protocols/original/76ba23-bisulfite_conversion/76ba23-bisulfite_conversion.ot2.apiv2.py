import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/76ba23-bisulfite_conversion/76ba23-bisulfite_conversion.ot2.apiv2.py"
...
def run(ctx):
    ...
    filename = f"protocols/detailed_action_json/76ba23-bisulfite_conversion.json"
    output_data = {
