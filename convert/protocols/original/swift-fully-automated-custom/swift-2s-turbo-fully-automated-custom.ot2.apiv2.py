import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/swift-fully-automated-custom/swift-2s-turbo-fully-automated-custom.ot2.apiv2.py"
...
def run(protocol):
    ...
    if a_index == 'yes':
        ...
        protocol.pause('You selected "No" to automated indexing. Please add  indices to samples. When ready to continue, click RESUME.')
    ...
    protocol.comment('Swift 2S Turbo DNA Library Kit completed.  Store freshly prepared libraries at 4C (-20C for long term), \
    ...
    filename = f"protocols/detailed_action_json/swift-fully-automated-custom.json"
    output_data = {
