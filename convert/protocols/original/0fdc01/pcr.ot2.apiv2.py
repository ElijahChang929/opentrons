import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/0fdc01/pcr.ot2.apiv2.py"
...
def run(ctx):
    ...
    for n in range(num_plates):
        ...
        if n < num_plates - 1:
            ctx.pause(f'Replace 20ul tiprack. Refill mastermix.  Ensure clean PCR plate on slot {pcr_plates[(n+1)//2].parent} before resuming.')
