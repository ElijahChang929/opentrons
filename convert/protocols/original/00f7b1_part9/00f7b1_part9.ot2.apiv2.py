import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/00f7b1_part9/00f7b1_part9.ot2.apiv2.py"
...
def run(ctx: protocol_api.ProtocolContext):
    ...
    filename = f"protocols/detailed_action_json/00f7b1_part9.json"
    output_data = {
