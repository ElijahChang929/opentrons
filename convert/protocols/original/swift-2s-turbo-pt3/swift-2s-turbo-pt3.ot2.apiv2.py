import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/swift-2s-turbo-pt3/swift-2s-turbo-pt3.ot2.apiv2.py"
...
def run(protocol):
    ...
    filename = f"protocols/detailed_action_json/swift-2s-turbo-pt3.json"
    output_data = {
