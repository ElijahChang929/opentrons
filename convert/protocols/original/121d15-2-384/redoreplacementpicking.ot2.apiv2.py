import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/121d15-2-384/redoreplacementpicking.ot2.apiv2.py"
...
# metadata
metadata = {
    'protocolName': 'Redo Replacement Picking (Greiner Masterblock 384 Well  Plate 225 µL)',
...
def run(ctx):
    ...
    filename = f"protocols/detailed_action_json/121d15-2-384.json"
    output_data = {
