import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/sci-omegabiotek-magbind-temp/sci-omegabiotek-magbind.ot2.apiv2.py"
...
#        'nest_12_reservoir_15ml', '3', 'reagent reservoir 2')
    ...
    filename = f"protocols/detailed_action_json/sci-omegabiotek-magbind-temp.json"
    output_data = {
