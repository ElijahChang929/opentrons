import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/1bcd67/normalization.ot2.apiv2.py"
...
def run(ctx):
    ...
    sample_str = '\n'.join([
        f'Transfer {display_vol}uL to well {display_well} of deepwell  plate on slot 8.'
    ...
    filename = f"protocols/detailed_action_json/1bcd67.json"
    output_data = {
