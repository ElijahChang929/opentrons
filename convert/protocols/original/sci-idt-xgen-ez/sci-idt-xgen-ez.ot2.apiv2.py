import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/sci-idt-xgen-ez/sci-idt-xgen-ez.ot2.apiv2.py"
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    filename = f"protocols/detailed_action_json/sci-idt-xgen-ez.json"
    output_data = {
