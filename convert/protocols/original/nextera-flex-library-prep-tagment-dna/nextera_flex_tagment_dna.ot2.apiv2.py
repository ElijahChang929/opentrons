import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/nextera-flex-library-prep-tagment-dna/nextera_flex_tagment_dna.ot2.apiv2.py"
...
def run(ctx):
    ...
    filename = f"protocols/detailed_action_json/nextera-flex-library-prep-tagment-dna.json"
    output_data = {
