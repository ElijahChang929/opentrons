import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/407d5e/407d5e.ot2.apiv2.py"
...
def run(protocol):
    ...
    protocol.comment('\nAdding 58.1uL of Tris to each Sample &  Distributing 20uL 5-times to Temperature Module\n')
    ...
    filename = f"protocols/detailed_action_json/407d5e.json"
    output_data = {
