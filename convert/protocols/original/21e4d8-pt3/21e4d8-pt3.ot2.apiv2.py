import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/21e4d8-pt3/21e4d8-pt3.ot2.apiv2.py"
...
def run(protocol):
    ...
    msg1 = 'Please seal plate, spin down, & transfer to thermocycler. When  complete, return plate to MagDeck. Make sure magbeads are mixed and in A1 \
    ...
    filename = f"protocols/detailed_action_json/21e4d8-pt3.json"
    output_data = {
