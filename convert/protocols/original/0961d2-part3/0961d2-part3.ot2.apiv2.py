import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/0961d2-part3/0961d2-part3.ot2.apiv2.py"
...
def run(protocol):
    ...
    protocol.comment('If bubbles are present, please centrifuge to remove  bubbles before proceeding to Part 4.')
