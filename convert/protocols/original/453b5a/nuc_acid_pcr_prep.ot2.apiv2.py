import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/453b5a/nuc_acid_pcr_prep.ot2.apiv2.py"
...
def run(ctx):
    ...
    def pick_up(pip):
        ...
        if pip == p20:
            ...
            if tips300_count == tips300_max:
                ctx.pause('Replace 300ul tiprack in slots 3, 6, and 9 before  resuming.')
                m300.reset_tipracks()
            m300.pick_up_tip()
            tips300_count += 1
    ...
    filename = f"protocols/detailed_action_json/453b5a.json"
    output_data = {
