import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/3e0bef/3e0b3f.ot2.apiv2.py"
...
def run(ctx: protocol_api.ProtocolContext):
    ...
    if not ctx.is_simulating:
        ...
        ctx.comment('Transferring 5uL RNAse + 500uL RBB buffer +  20uL Mag-Bind Beads')
        ...
        ctx.home()
        air_dry_msg = f'Air drying the beads for {air_dry} minutes.  Please add elution buffer at 65C to 12-well reservoir.'
    ...
    filename = f"protocols/detailed_action_json/3e0bef.json"
    output_data = {
