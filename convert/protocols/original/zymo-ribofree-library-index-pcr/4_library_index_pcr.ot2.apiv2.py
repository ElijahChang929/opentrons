import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/zymo-ribofree-library-index-pcr/4_library_index_pcr.ot2.apiv2.py"
...
def run(ctx):
    ...
    filename = f"protocols/detailed_action_json/zymo-ribofree-library-index-pcr.json"
    output_data = {
