import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/44b1ac/44b1ac.ot2.apiv2.py"
...
def run(ctx):
    ...
    filename = f"protocols/detailed_action_json/44b1ac.json"
    output_data = {
