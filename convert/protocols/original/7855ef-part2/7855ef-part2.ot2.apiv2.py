import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/7855ef-part2/7855ef-part2.ot2.apiv2.py"
...
def run(protocol):
    ...
    filename = f"protocols/detailed_action_json/7855ef-part2.json"
    output_data = {
