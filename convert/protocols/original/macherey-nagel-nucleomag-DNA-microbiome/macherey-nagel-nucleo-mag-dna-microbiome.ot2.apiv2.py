import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/macherey-nagel-nucleomag-DNA-microbiome/macherey-nagel-nucleo-mag-dna-microbiome.ot2.apiv2.py"
...
metadata = {'protocolName': 'NucleoMag_DNA_Microbiome_Rev01', 'author': 'Macherey-Nagel <automation-bio@mn-net.com>', 'apiLevel': '2.9'}
...
def run(ctx):
    ...
    [num_samples,
     ...
     sep_time_elu,
     dry_time,
     tip_track] = [48, 500, 100, 310, 25, 600, 600, 600, 600, 25, 20, 25, 5, 2, 5, 30, False]
    ...
    if not 350 <= starting_vol <= 500:
        raise Exception('Starting volume should be from 350 - 500µl.')
    ...
    Define reagents
        ...
        Well 1 & 2 Binding Buffer MI2
        Well 3 & 4 Wash Buffer MI3 for 1st Wash
        Well 5 & 6 Wash Buffer MI3 for 2nd Wash
        Well 7 & 8 Wash Buffer MI4 for 3rd Wash
        Well 9 & 10 70% ethanol for 4th Wash
        Well 11 empty
        Well 12 Elution Buffer MI5
    ...
    wash4 = buffers.wells()[8:10]
    placeholder = buffers.wells()[10]
    ...
    wash(wash3_vol, wash3, reuse=False, restore=False, resuspend=True, last=False, blowout=False)
    wash(wash4_vol, wash4, reuse=False, restore=False, resuspend=True, last=True, blowout=False)
    ...
    filename = f"protocols/detailed_action_json/macherey-nagel-nucleomag-DNA-microbiome.json"
    output_data = {
