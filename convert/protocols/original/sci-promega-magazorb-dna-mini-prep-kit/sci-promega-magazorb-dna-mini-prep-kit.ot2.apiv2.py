import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/sci-promega-magazorb-dna-mini-prep-kit/sci-promega-magazorb-dna-mini-prep-kit.ot2.apiv2.py"
...
def run(ctx):
    ...
    filename = f"protocols/detailed_action_json/sci-promega-magazorb-dna-mini-prep-kit.json"
    output_data = {
...
#    tempdeck = ctx.load_module('Temperature Module Gen2', '1')
    ...
    bottomright = magplate['A1'].bottom().move(types.Point(x=3.8, y=-3.8,
                                                           z=0.1))
    # bottomleft = magplate['A1'].bottom().move(types.Point(x=-3.8, y=-3.8,
    #                                                       z=0.1))
