import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/4b4a80-pcr_enrichment/4b4a80-pcr_enrichment.ot2.apiv2.py"
...
def run(ctx):
    ...
    filename = f"protocols/detailed_action_json/4b4a80-pcr_enrichment.json"
    output_data = {
