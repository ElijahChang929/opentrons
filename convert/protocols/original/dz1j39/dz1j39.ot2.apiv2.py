import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/dz1j39/dz1j39.ot2.apiv2.py"
...
metadata = {
    ...
    'author': 'Opentrons',
    'description': 'To measure viability and cytotoxicity of A549 cells treated with Thapsigargin using the OT-2',
    'apiLevel': '2.13'
}
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    # commands
    # Day 4 (After 72 hours) measurement of viability and cytotoxicity of  # A549 cells
    ...
    filename = f"protocols/detailed_action_json/dz1j39.json"
    output_data = {
