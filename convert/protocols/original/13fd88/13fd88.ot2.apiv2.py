import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/13fd88/13fd88.ot2.apiv2.py"
...
def run(protocol):
    ...
    pmsg = "Please remove deepwell plate and centrifuge. When done,  replace on deck and click RESUME"
    protocol.pause(pmsg)
    ...
    filename = f"protocols/detailed_action_json/13fd88.json"
    output_data = {
