import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/opentrons/convert/protocols/original/21e4d8-pt1/21e4d8-pt1.ot2.apiv2.py"
...
def run(protocol):
    ...
    protocol.comment('Protocol complete.  Please move plate to thermocycler & prepare for step 2.')
