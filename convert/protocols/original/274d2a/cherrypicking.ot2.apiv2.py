import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep Potential/opentrons/convert/protocols/original/274d2a/cherrypicking.ot2.apiv2.py"
...
def run(ctx):
    ...
    for line in transfer_info:
        ...
        if pip.type == 'multi' and (
            ...
            ctx.pause('Warning: attempting to use multi-channel pipette on  rows other than row A.')
    ...
    filename = f"protocols/detailed_action_json/274d2a.json"
    output_data = {
